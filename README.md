...
This repository gathers resources across many topics in hopes to save and organize them for future reference. Therefore, the main goal of it is to help me when configuring future setups or when trying to remember some important (and often obscure) reference, however, it would be great if it could help others too. This repository was inspired by many others, like the ones done by [Ricardo Dahis](https://github.com/rdahis) and [Vinícius Hector](https://github.com/HecVini).
